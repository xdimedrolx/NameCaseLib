...
class NameCaseRuTest extends TestCase
{
    /**
     * @var NameCaseRu
     */
    ...
    public function test1()
    {
        ...
        $this->object->setGender(NameCaseRu::$MAN);
        $this->assertEquals('Николаем', $this->object->getFirstNameCase(NameCaseRu::$TVORITELN));
    }
    ...
    public function test3()
    {
        ...
        $this->assertEquals('Николаевичу', $this->object->getFatherNameCase(NameCaseRu::$DATELN));
    }
    ...
    public function test7()
    {
        ...
        $this->object->setGender(NameCaseRu::$WOMAN);
        $this->assertEquals('Гайки-Русланы-Петровны', $this->object->getFormatted(NameCaseRu::$RODITLN, "S-N-F"));
    }
    ...
    {
        $this->assertEquals('комментария', $this->object->qFirstName('комментарий',NameCaseRu::$RODITLN , NameCaseRu::$MAN));
    }
}