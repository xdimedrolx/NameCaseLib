...
class NCLStr
{
     ...
     */
    public static function isLowerCase($phrase)
    {
     ...
     */
    public static function isUpperCase($phrase)
    {
     ...
     */
    public static function splitLetters($phrase)
    {
        $resultArr = array();
     ...
     */
    public static function connectLetters($lettersArr)
    {
     ...
     */
    public static function explode($pattern, $string)
    {
